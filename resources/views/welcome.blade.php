              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-1 inner">
                  <h1 class="animated fadeInDown">
                    BI<span style="color:#E04343;">M</span>AL<br/>
                    <span>SH<span style="color:#FFE800">AR</span>MA</span>
                  </h1><!-- Title -->
                  <h3 class="animated fadeInUp delay-05s"><span class="rotate">Web Developer Software Developer</span></h3><!-- Text Rotator -->
                </div>
              </div>
              <!-- Learn More Button -->
              <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                  <a href="index.php#about" class="scrollto wow fadeInUp delay-5s ">
                        <p>SEE MORE</p>
        ...
        <div class="container-fluid">
            ...
            <div class="row color-bg">
                ...
                <div class="col-md-6 about-text">
                    <h6>High quality Android develop</h6><!-- headline-->
            ...
            <div class="row">
                <div class="col-md-6 about-text">
                    <h6>High quality Web develop</h6><!-- Headline -->
    ...
    =========================== -->
        ...
        <div class="spacer-cta text-center">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <a href="#contact" class="outline-btn">hire Bimal Sharma</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row contact-details">
              ...
              <div class="col-md-4">
                <div class="dark-box box-hover">
                  ...
                  <p>Bindabashini, 2 Pokhara Nepal</p>
                </div>
              </div>
              <!-- Phone Number Box -->
              <div class="col-md-4">
              ...
              <div class="col-md-4">
                <div class="dark-box box-hover">
                  ...
                  <p><a href="index.html#">info@bsharma.com.np</a></p>
                   <p><a href="index.html#">brsbimal@gmail.com</a></p>
                </div>
              </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="{{$message->name or ''}}"name="name" placeholder="Your name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <!-- Phone Number -->
                                    <div class="form-group">
                                        <input type="email" class="form-control" value="{{$message->email or ''}}"name="email" placeholder="Email address">
                                    </div>
                                </div>
                            </div>
                            <!-- Message Area -->
                            <div class="form-group">
                                <textarea class="form-control" name="message" placeholder="Write you message here..." style="height:232px;"> {{$message->message or '' }}</textarea>
                            </div>
                            <!-- Subtmit Button -->
            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="social-buttons">
                  <li><a href="bbsrma.com.np" class="social-btn"><i class="fa fa-dribbble"></i></a></li><!-- dribble -->
                  <li><a href="https://twitter.com/BimalRajSharma" class="social-btn"><i class="fa fa-twitter"></i></a></li><!-- twitter -->
                  <li><a href="https://www.facebook.com/bbsrma" class="social-btn"><i class="fa fa-facebook"></i></a></li><!-- facebook -->
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <p>All Rights Reserved. &copy; 2015 <a href="http://www.bsharma.com.np">bsharma.com.np</a>
                    {{$ipaddress or '' }}</p>
              </div>
            </div>
          </div>
    ...
    // When the window has finished loading create our google map below
        ...
        function init() {
            ...
            var mapOptions = {
                ...
                center: new google.maps.LatLng(28.209499,83.959518), // New York 
